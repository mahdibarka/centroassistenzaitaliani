...
<head>
  ...
  <title>Centro Assistenza Italiani</title>
...
<body>
        ...
        <div class="container-fluid">
          <div class="contact_link-container">
            ...
            <a href="" class="contact_link3">
              ...
              <span>
                Centroassistenzaitaliani@gmail.com
              </span>
            </a>
          </div>
        </div>
          ...
          <nav class="navbar navbar-expand-lg custom_nav-container">
            ...
            <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="guard.html"> Localisation </a>
                </li>
                <li class="nav-item">
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    <h1>
                      A consultancy agency serving  <br>
                      <span>
                        Italians in Tunisia.
                      </span>
                    </h1>
                    <p>
                      "At Centro Assistenza Italiani, we provide consultancy services for Italians in Tunisia, offering expert support in legal and administrative aspects to ensure a smooth and comfortable experience."
                    </p>
                    <div class="btn-box">
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    ...
                    <p>
                      Centro Assistenza Italiani est une agence de conseil spécialisée dans l'accompagnement des citoyens italiens résidant en Tunisie. Fondée avec la mission de faciliter la vie des expatriés italiens, notre agence se distingue par son expertise dans les aspects juridiques et administratifs, offrant des solutions adaptées aux besoins spécifiques de nos clients.
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn-1"> Read more </a>
                      <a href="" class="btn-2">Get A Quote</a>
      ...
      <div class="row">
        <div class="col-md-6 px-0">
          <div class="img_container">
            <div class="img-box">
              <img src="images/contact-bg (2).jpg" alt="" />
            </div>
          </div>
        </div>
        <div class="col-md-6 px-0">
          <div class="detail-box">
            ...
            <p>
              Centro Assistenza Italiani is a consultancy agency dedicated to providing support to Italian citizens residing in Tunisia. Established with the aim of simplifying the lives of Italian expatriates, our agency excels in legal and administrative matters, offering tailored solutions to meet our clients' needs.
            </p><br><br>
            <div class="btn-box">
              <a href="">
                Read More
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                At Centro Assistenza Italiani, we offer a comprehensive range of consultation services tailored to the specific needs of Italians living in Tunisia.
              <br>
              <br>
              </p>
              <a href="">
        ...
        <div class="col-md-4">
          ...
          c10.095-0.01,18.276-8.191,18.286-18.286V283.429C475.419,273.334,467.238,265.153,457.143,265.143z" />
            ...
            <div class="detail-box">
              <h6>Professional and Personal Assistance
              </h6>
              <p>
                Centro Assistenza Italiani also specializes in professional and personal assistance aimed at facilitating your transition and maximizing your experience in Tunisia.<br><br>
              </p>
              <a href="">
                Read More
              </a>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                The Centro Assistenza Italiani agency also specializes in providing professional and personal support designed to ease your transition and enhance your experience in Tunisia.
              </p>
              <a href="">
                Read More
              </a>
  ...
  <section class="client_section layout_padding">
    <div class="container ">
      ...
      <section id="location" class="py-5 navbar-dark bg-dark" style=" background-size: cover; background-position: center;">
        <div class="overlay">
            <div class="container">
                <h2 class="text-center mb-4 text-light">Localisation</h2>
                <div class="row">
                    <div class="col-md-6">
                        <!-- Embed Google Map -->
                        <iframe class="w-100" height="450" style="border:0;" loading="lazy" allowfullscreen
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3650.156078225517!2d10.602081611684019!3d36.405956289708136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13029e1ced9d2285%3A0x5694ce0ae36521d9!2sRestaurant%20La%20Luna.%20Pizzeria...four%20a%20bois!5e1!3m2!1sen!2stn!4v1725020337786!5m2!1sen!2stn"></iframe>
                    </div>
                    <div class="col-md-6">
                        <!-- YouTube Video -->
                        <iframe class="w-100" height="450" style="border:0;" loading="lazy"  src="https://www.youtube.com/embed/FlRwssZYRM0?si=fZB7mleJiNk4ruFa" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="info_logo">
            ...
            <p>
              "Centro Assistenza Italiani offers personalized support and expert guidance for Italians in Tunisia,
            </p>
          </div>
        </div>
        <div class="col-md-3">
          ...
          <div class="info_contact">
            <a href="" class="">
              ...
              <span>
                ...
                Av de la Repubblica, 33 
                Gouvernorat de Nabeul, 8050
              </span>
            </a>
            <a href="" class="">
              <i class="fa fa-phone" aria-hidden="true"></i>
              <span>
                Call : (+216) 72 26 36 61
              
              </span></br>
              <i class="fa fa-phone" aria-hidden="true"></i>
              <span>
              
                Call : (+216) 29 13 77 85
          
              </span></br><i class="fa fa-phone" aria-hidden="true"></i>
              <span>
...
centroassistenzaitaliani@gmail.com
  ...
  <footer class="container-fluid footer_section">
    <p>
      ...
      <a href="user_interface.html">Free Html Templates</a>
    </p>
  </footer>
  <!-- footer section -->
